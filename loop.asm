...
int main(int argc, char *argv[])
{
  ...
  12:	8b 59 04             	mov    0x4(%ecx),%ebx
    ...
    // }
    int p=fork();
  15:	e8 c0 02 00 00       	call   2da <fork>
    if(p==0)
  1a:	85 c0                	test   %eax,%eax
  1c:	75 37                	jne    55 <main+0x55>
    {
            long long int x = 0;

        for (volatile long long int i = 0; i < 1000000000; i++)
  1e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  25:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  2f:	8b 55 f4             	mov    -0xc(%ebp),%edx
  32:	83 fa 00             	cmp    $0x0,%edx
  35:	7e 23                	jle    5a <main+0x5a>
            {
                x++;
            }
        printf(1,"%d\n", atoi(argv[1]));
  ...
  3d:	e8 2e 02 00 00       	call   270 <atoi>
  42:	83 c4 0c             	add    $0xc,%esp
  45:	50                   	push   %eax
  46:	68 a8 07 00 00       	push   $0x7a8
  4b:	6a 01                	push   $0x1
  4d:	e8 fe 03 00 00       	call   450 <printf>
  52:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  55:	e8 88 02 00 00       	call   2e2 <exit>
        for (volatile long long int i = 0; i < 1000000000; i++)
  5a:	7c 0b                	jl     67 <main+0x67>
  5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  60:	3d ff c9 9a 3b       	cmp    $0x3b9ac9ff,%eax
  65:	77 d0                	ja     37 <main+0x37>
  67:	8b 45 f0             	mov    -0x10(%ebp),%eax
  6a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  6d:	83 c0 01             	add    $0x1,%eax
  70:	83 d2 00             	adc    $0x0,%edx
  73:	89 45 f0             	mov    %eax,-0x10(%ebp)
  76:	89 55 f4             	mov    %edx,-0xc(%ebp)
  79:	8b 45 f0             	mov    -0x10(%ebp),%eax
  7c:	8b 55 f4             	mov    -0xc(%ebp),%edx
  7f:	83 fa 00             	cmp    $0x0,%edx
  82:	7c e3                	jl     67 <main+0x67>
  84:	7f b1                	jg     37 <main+0x37>
  86:	eb d8                	jmp    60 <main+0x60>
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
 ...
 621:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 777:	0a 00 00 
 77a:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 60 0a 00 00       	mov    $0xa60,%eax
 789:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 790:	00 00 00 
