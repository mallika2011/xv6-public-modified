...
int main(int argc, char *argv[])
{
   ...
   e:	83 ec 14             	sub    $0x14,%esp
    ...
    int p=fork();
  11:	e8 94 02 00 00       	call   2aa <fork>
    if(p==0)
  16:	85 c0                	test   %eax,%eax
  18:	75 3a                	jne    54 <main+0x54>
	{
