  ...
  12:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  29:	e8 ec 02 00 00       	call   31a <exec>
			printf(1, "Exec %s Failed\n", argv[1]);
  2e:	83 c4 0c             	add    $0xc,%esp
  31:	ff 73 04             	pushl  0x4(%ebx)
  34:	68 bf 07 00 00       	push   $0x7bf
  39:	6a 01                	push   $0x1
  3b:	e8 10 04 00 00       	call   450 <printf>
			exit();
  40:	e8 9d 02 00 00       	call   2e2 <exit>
		}
		else
		{
			status = waitx(&a, &b);
  ...
  6c:	e8 71 02 00 00       	call   2e2 <exit>
		printf(1, "Usage: time <process>\n");
  71:	51                   	push   %ecx
  72:	51                   	push   %ecx
  73:	68 a8 07 00 00       	push   $0x7a8
  78:	6a 01                	push   $0x1
  7a:	e8 d1 03 00 00       	call   450 <printf>
		exit();
