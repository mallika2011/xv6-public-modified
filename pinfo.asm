  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  1f:	e8 4c 02 00 00       	call   270 <atoi>
        if (getpinfo(&p, pid) < 0)
  24:	5a                   	pop    %edx
  25:	59                   	pop    %ecx
  26:	50                   	push   %eax
  ...
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 bf 07 00 00       	push   $0x7bf
  6e:	6a 01                	push   $0x1
  70:	e8 db 03 00 00       	call   450 <printf>
            exit();
  75:	e8 68 02 00 00       	call   2e2 <exit>
        printf(1, "Usage: getpinfo <PID>\n");
  7a:	50                   	push   %eax
  7b:	50                   	push   %eax
  7c:	68 a8 07 00 00       	push   $0x7a8
  81:	6a 01                	push   $0x1
