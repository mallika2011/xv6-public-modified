  ...
  13:	83 39 01             	cmpl   $0x1,(%ecx)
{
  16:	8b 41 04             	mov    0x4(%ecx),%eax
    if (argc < 2)
  19:	0f 8e a5 00 00 00    	jle    c4 <main+0xc4>
  ...
  22:	ff 70 04             	pushl  0x4(%eax)
        if (getpinfo(&p, pid) ==-1)
  25:	8d 75 c0             	lea    -0x40(%ebp),%esi
        pid = atoi(argv[1]);
  ...
  31:	53                   	push   %ebx
  32:	56                   	push   %esi
  33:	e8 b2 03 00 00       	call   3ea <getpinfo>
  38:	83 c4 10             	add    $0x10,%esp
  3b:	83 c0 01             	add    $0x1,%eax
  3e:	74 71                	je     b1 <main+0xb1>
        {
  ...
  42:	53                   	push   %ebx
  43:	56                   	push   %esi
  44:	e8 a1 03 00 00       	call   3ea <getpinfo>
  49:	83 c4 10             	add    $0x10,%esp
  4c:	83 f8 fe             	cmp    $0xfffffffe,%eax
  4f:	0f 84 82 00 00 00    	je     d7 <main+0xd7>
        {
  ...
  55:	52                   	push   %edx
  56:	52                   	push   %edx
  57:	68 58 08 00 00       	push   $0x858
  5c:	6a 01                	push   $0x1
  5e:	e8 4d 04 00 00       	call   4b0 <printf>
        printf(1, "\033[01;33mpid = %d\nnum_run = %d\ncurrent queue = %d\nruntime = %d\n\033[0m", p.pid, p.num_run, p.current_queue, p.runtime);
  63:	59                   	pop    %ecx
  64:	5b                   	pop    %ebx
  65:	ff 75 c4             	pushl  -0x3c(%ebp)
  68:	ff 75 cc             	pushl  -0x34(%ebp)
        for(int i=0; i<5; i++)
  6b:	31 db                	xor    %ebx,%ebx
        printf(1, "\033[01;33mpid = %d\nnum_run = %d\ncurrent queue = %d\nruntime = %d\n\033[0m", p.pid, p.num_run, p.current_queue, p.runtime);
  6d:	ff 75 c8             	pushl  -0x38(%ebp)
  70:	ff 75 c0             	pushl  -0x40(%ebp)
  73:	68 78 08 00 00       	push   $0x878
  78:	6a 01                	push   $0x1
  7a:	e8 31 04 00 00       	call   4b0 <printf>
  7f:	83 c4 20             	add    $0x20,%esp
        {
            printf(1,"ticks[%d]=%d \t",i,p.ticks[i]);
  82:	ff 74 9e 10          	pushl  0x10(%esi,%ebx,4)
  86:	53                   	push   %ebx
        for(int i=0; i<5; i++)
  87:	83 c3 01             	add    $0x1,%ebx
            printf(1,"ticks[%d]=%d \t",i,p.ticks[i]);
  8a:	68 49 08 00 00       	push   $0x849
  8f:	6a 01                	push   $0x1
  91:	e8 1a 04 00 00       	call   4b0 <printf>
        for(int i=0; i<5; i++)
  96:	83 c4 10             	add    $0x10,%esp
  99:	83 fb 05             	cmp    $0x5,%ebx
  9c:	75 e4                	jne    82 <main+0x82>
        }
        printf(1,"\n");
  9e:	50                   	push   %eax
  9f:	50                   	push   %eax
  a0:	68 1d 08 00 00       	push   $0x81d
  a5:	6a 01                	push   $0x1
  a7:	e8 04 04 00 00       	call   4b0 <printf>
        exit();
  ac:	e8 91 02 00 00       	call   342 <exit>
            printf(1, "Error: No such process\n");
  b1:	50                   	push   %eax
  b2:	50                   	push   %eax
  b3:	68 1f 08 00 00       	push   $0x81f
  b8:	6a 01                	push   $0x1
  ba:	e8 f1 03 00 00       	call   4b0 <printf>
            exit();
  bf:	e8 7e 02 00 00       	call   342 <exit>
        printf(1, "Usage: getpinfo <PID>\n");
  c4:	51                   	push   %ecx
  c5:	51                   	push   %ecx
  c6:	68 08 08 00 00       	push   $0x808
  cb:	6a 01                	push   $0x1
  cd:	e8 de 03 00 00       	call   4b0 <printf>
        exit();
  d2:	e8 6b 02 00 00       	call   342 <exit>
            printf(1,"Invalid priority\n");
  d7:	56                   	push   %esi
  d8:	56                   	push   %esi
  d9:	68 37 08 00 00       	push   $0x837
  de:	6a 01                	push   $0x1
  e0:	e8 cb 03 00 00       	call   4b0 <printf>
            exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb bc 08 00 00       	mov    $0x8bc,%ebx
        while(*s != 0){
 ...
 681:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 70 0b 00 00    	cmp    %eax,0xb70
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 ...
 7d7:	0b 00 00 
 7da:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 7e1:	0b 00 00 
    base.s.size = 0;
 7e4:	b8 74 0b 00 00       	mov    $0xb74,%eax
 7e9:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 7f0:	00 00 00 
